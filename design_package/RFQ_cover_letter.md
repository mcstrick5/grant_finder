...
Retrofit module for a standard folding aluminium bedside commode that lets a caregiver empty the waste pan
...
This is a concept design based on standard commode dimensions and has not been physically tested.
Fit to the actual base chair and all structural/safety validation are to be performed by the supplier.


Please reply with your quotation and any design comments. Thank you.